...
> Άνοιγμα αυτής της σελίδας στο [https://myschoolteamgr.github.io/name-tag/](https://myschoolteamgr.github.io/name-tag/)
...
* αναζήτηση για **https://github.com/myschoolteamgr/name-tag** και εισαγωγή
...
* επικολλήστε **https://github.com/myschoolteamgr/name-tag** και κάντε κλικ στην εισαγωγή
